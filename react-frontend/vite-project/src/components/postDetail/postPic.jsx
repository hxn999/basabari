...
export function PostPic()
{
    ...
    let gridRow = "grid-rows-3"
    if(data.isSinglePost)
    {

        if(data.singlePost.post[0].images.length>7)
            {
                gridRow="grid-rows-4"
            }
        }
    return(
        ...
        <section className="mx-auto max-w-7xl mt-2 px-8">
                ...
                <div className="flex gap-3 h-96 max-[700px]:flex-col max-[700px]:h-auto">
                    ...
                    <div
                        className={`grid grid-cols-2 w-2/5 gap-3 h-96 ${gridRow} max-[700px]:w-full max-[700px]:grid-cols-6 max-[700px]:grid-rows-none max-[700px]:h-auto`}>
                            {
                               data.isSinglePost? 
