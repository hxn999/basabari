...
import {  useAdminPostEditMutation,  } from "../../../../redux/slice/apiSlice.js";


export function AdminPostCard({ post }) {
    ...
    return (
        ...
        <>
            <div className="flex flex-col p-3 rounded-xl gap-3 shadow-md border-2 border-gray-100" alt="">
                ...
                <Link to={`/admin${import.meta.env.VITE_REACT_APP_ADMIN_URL}/post/edit/${post._id}`} relative='/'>
                ...
                {
                    post.isApproved ? <button className="bg-red-400 rounded-xl py-2 w-full btn hover:bg-red-700" onClick={() => {
                        adminPostEdit({
                            _id:post._id,
                            data:{
                                isApproved:false
