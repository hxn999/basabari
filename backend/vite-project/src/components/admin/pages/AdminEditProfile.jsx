...
// import { useCreateUserMutation, useEditProfileMutation, useProfileQuery } from '../../redux/slice/apiSlice.js'
...
import { useAdminUserEditMutation, useSingleUserQuery } from '../../../../redux/slice/apiSlice.js'
...
export function AdminEditProfile() {
    ...
    const { data: profile, error: pfpError, isSuccess: isPfpSuccess, isError: isPfpError, isLoading: isPfpLoading } = useSingleUserQuery({userId,post:false})

    const [adminUserEdit, { data, error, isError, isLoading, isSuccess }] = useAdminUserEditMutation()
    ...
    if (isSuccess) {
        toast.success("Profile edited by admin Successfully !!")
